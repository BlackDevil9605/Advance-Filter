...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001856808251').split()]
...
URL = "https://movie-bot-1-0.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://movie-bot-1-0.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://movie-bot-1-0.onrender.com/".format(FQDN)
else:
    URL = "https://movie-bot-1-0.onrender.com/".format(FQDN)
